...
def dataset(tp, grid_size):
	with open('synthetic_data/gaussian/ground_truth_dataset_{}.pickle'.format(grid_size),'rb') as tf:
		gt = pickle.load(tf)
	with open('synthetic_data/gaussian/mask_dataset_{}.pickle'.format(grid_size),'rb') as rf:
		masks = pickle.load(rf)
	with open('synthetic_data/gaussian/image_dataset_{}.pickle'.format(grid_size),'rb') as f:
		images = pickle.load(f)
	with open('synthetic_data/gaussian/ground_truth_dataset_peristenceDgm_z_{}.pickle'.format(grid_size),'rb') as f:
		persistence_z = pickle.load(f)
	with open('synthetic_data/gaussian/ground_truth_dataset_peristenceDgm_f_{}.pickle'.format(grid_size),'rb') as f:
