...
size = 24
with open('./gaussian/ground_truth_dataset_{}.pickle'.format(size),'rb') as tf:
...
with open('./gaussian/ground_truth_dataset_peristenceDgm_z_{}.pickle'.format(size), 'wb') as handle:
	pickle.dump(persistence_z, handle)

with open('./gaussian/ground_truth_dataset_peristenceDgm_f_{}.pickle'.format(size), 'wb') as handle:
