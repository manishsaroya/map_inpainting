...
parser.add_argument('--save_dir', type=str, default='./snapshots/posticra_actual_without_toploss_long')
parser.add_argument('--log_dir', type=str, default='./logs/posticra_actual_without_toploss_long')
parser.add_argument('--log_dir_val', type=str, default='./logs/posticra_actual_without_toploss_long_validation')
