...
parser.add_argument('--save_dir', type=str, default='./snapshots/plain')
parser.add_argument('--log_dir', type=str, default='./logs/plain')
parser.add_argument('--log_dir_val', type=str, default='./logs/plain_validation')
