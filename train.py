...
parser.add_argument('--save_dir', type=str, default='./snapshots/gaussian')
parser.add_argument('--log_dir', type=str, default='./logs/gaussian')
parser.add_argument('--log_dir_val', type=str, default='./logs/gaussian_validation')
