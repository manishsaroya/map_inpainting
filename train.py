...
parser.add_argument('--save_dir', type=str, default='./snapshots/pixel_wise')
parser.add_argument('--log_dir', type=str, default='./logs/pixel_wise')
parser.add_argument('--log_dir_val', type=str, default='./logs/pixel_wise_validation')
